<?php
/**
 * Mondido gateway mondido invoice
 *
 * @author Mondido
 * @package mondido
 **/
...
/**
 * Class WC_Gateway_Mondido_Invoice
 */
class WC_Gateway_Mondido_Invoice extends WC_Gateway_Mondido_HW {
	...
	public function __construct() {
		...
		add_filter( 'woocommerce_mondido_form_fields', array( $this, 'set_payment_method' ), 10, 3 );
		...
		add_action( 'woocommerce_api_wc_gateway_' . $this->id, array( $this, 'notification_callback' ) );
